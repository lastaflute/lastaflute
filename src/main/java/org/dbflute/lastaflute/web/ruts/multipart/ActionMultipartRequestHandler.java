...
import org.dbflute.lastaflute.web.ruts.multipart.exception.MultipartExceededException;
import org.dbflute.lastaflute.web.util.LaServletContextUtil;
 ...
 */
public class ActionMultipartRequestHandler implements MultipartRequestHandler {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(ActionMultipartRequestHandler.class);
    ...
    protected Hashtable<String, MultipartFormFile> elementsFile;
    ...
    protected void handleSizeLimitExceededException(HttpServletRequest request, SizeLimitExceededException e) {
        ...
        request.setAttribute(MAX_LENGTH_EXCEEDED_KEY, new MultipartExceededException(msg, e, actual, permitted));
        try {
    ...
    @Override
    public Hashtable<String, MultipartFormFile> getFileElements() {
        return elementsFile;
    }
