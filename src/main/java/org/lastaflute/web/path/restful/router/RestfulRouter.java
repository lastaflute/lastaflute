...
public interface RestfulRouter {
    ...
    OptionalThing<UrlMappingOption> toRestfulMappingPath(UrlMappingResource resource);

    OptionalThing<UrlReverseOption> toRestfulReversePath(UrlReverseResource resource);
}