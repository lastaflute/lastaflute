...
/**
 * The validator annotation as short for string.
 * @author jflute
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = ShortTypeValidator.class)
@LastaPresentsValidator
public @interface TypeShort {

    String DEFAULT_MESSAGE = "{org.lastaflute.validator.constraints.TypeShort.message}";
