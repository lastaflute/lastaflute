...
/**
 * The validator annotation as big integer for string.
 * @author jflute
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = BigIntegerTypeValidator.class)
@LastaPresentsValidator
public @interface TypeBigInteger {

    String DEFAULT_MESSAGE = "{org.lastaflute.validator.constraints.TypeBigInteger.message}";
