...
/**
 * The validator annotation as local date-time for string.
 * @author jflute
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = LocalDateTimeTypeValidator.class)
@LastaPresentsValidator
public @interface TypeLocalDateTime {

    String DEFAULT_MESSAGE = "{org.lastaflute.validator.constraints.TypeLocalDateTime.message}";
